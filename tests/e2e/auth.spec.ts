...
test(
  "mail scanners cannot consume a token and explicit confirmation signs in exactly once",
  async ({ page, request }) => {
...
test(
  "magic link sending is bounded per normalized email after a valid challenge",
  async ({ request }) => {
