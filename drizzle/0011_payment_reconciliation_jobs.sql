...
CREATE TABLE "payment_reconciliation_jobs" (
	...
	CONSTRAINT "payment_reconciliation_job_attempts_valid" CHECK ("payment_reconciliation_jobs"."attempts" >= 0 and "payment_reconciliation_jobs"."attempts" <= 12 and (("payment_reconciliation_jobs"."state" = 'dead_letter' and "payment_reconciliation_jobs"."attempts" = 12) or ("payment_reconciliation_jobs"."state" <> 'dead_letter' and "payment_reconciliation_jobs"."attempts" < 12))),
...
CREATE UNIQUE INDEX "payment_reconciliation_order_uq" ON "payment_reconciliation_jobs" USING btree ("order_id");--> statement-breakpoint
